...
namespace Schumacher
{
    internal class Schumi
    {
        ...
        public Schumi(DateTime date, string grandprix, int position, int laps, int points, string team, string status)
        {
            Date=date;
            Grandprix=grandprix;
            Position=position;
        ...
        public Schumi(string beolvasottsor)
        {
